...
echo -e '
     ...
     |_| \_\  /_/   \_\ |   v     \_____|
      ...
      \e[35m  ☠         Code  : R4N3    ☠
	  \e[34m☠	     Github : Bilinmiyor      ☠
	 \e[33m☠  	    Youtube : Bilinmiyor           ☠
	\e[32m☠ 	   İnstagram : @0_r4n3_0       ☠
	
	\e[36m 	 hazmatinsta.com - R4N3 	
...
#menu 23
	...
	pkg install proot -y
        ...
        bash ubuntu.sh
        sleep 2
        mv -v RaneTools-ubuntu.sh /data/data/com.termux/files/usr/bin
        sleep 2
        echo -e '\033[31;40;1mKurulum Tamamlandı...'
	cd $HOME/RaneTools
        bash ranebommer.sh
